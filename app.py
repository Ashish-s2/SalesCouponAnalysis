...
# 🚀 Ultra Streamlit Dashboard - Maxed for Visuals, Filters, Insights, & More
...
categories = st.sidebar.multiselect("🛍️ Select Product Category", df['product_category'].unique(), default=df['product_category'].unique())
coupons = st.sidebar.multiselect("🎟️ Select Coupon Type", df['coupon_type'].unique(), default=df['coupon_type'].unique())
...
---
<center>
<h5>Built with ❤️ by Ashish Sahu — Biomedical x Data</h5>
